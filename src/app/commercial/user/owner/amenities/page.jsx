...
import { propertyFacing } from "@/components/constants";
import Button from "@/components/Button/Button";
import { useState } from 'react';
import PostModal from '@/components/PostModal';
import FeedbackModal from '@/components/FeedbackModal';
import NavigationCOwner from '@/components/Navigation/NavigationCOwner';
        ...
        <section className='mt-12 container mx-auto lg:w-4/5'>
            ...
            <div className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-20 container mx-auto my-10 overflow-auto'>
                ...
                <div className='h-full w-[400px] rounded-xl bg-[#c9e0ee] p-4 flex flex-col items-center mt-5'>
                    ...
                    <Image src={'/assets/amenities.png'} alt='amenities' height={200} width={200} className='mt-3 mb-10' />
            ...
            <button   onClick={openPostModal} className='w-full bg-blue-600 rounded-xl px-8 py-3 font-bold text-white mt-5 mb-10'>Post Your Property</button>
