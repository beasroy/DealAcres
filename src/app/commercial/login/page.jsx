        ...
        <section className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-20 container mx-auto my-10 overflow-auto'>
            <div className='h-full w-[400px] rounded-xl bg-[#e9f6fe] p-4 flex flex-col items-center'>
                <div className='flex flex-row items-center gap-2 mt-20 mb-5'>
                    <Image src={'/assets/thumbsup.png'} alt='authentication' height={40} width={40} className='mt-3 mb-10' />
                    <h1 className="text-lg mb-4">
                        Your Phone number gives<br /> access to your account.</h1>
                </div>
                <Image src={'/assets/authentication.png'} alt='authentication' height={280} width={280} className='mt-3 mb-10' />
            ...
            <div className='h-full md:w-[400px] md:mt-20 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
                ...
                <button className='w-full bg-blue-600 rounded-md px-8 py-3 font-bold text-white mb-3'>Verify & Login</button>
                <button className='w-full bg-white rounded-xl px-8 py-3 font-bold border-4 border-blue-600 text-blue-600 mb-4'>Login via - E-mail</button>
                </Link>
            </div>
        </section>
    )
